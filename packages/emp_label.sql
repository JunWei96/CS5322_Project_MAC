...
CREATE OR REPLACE PACKAGE BODY LABEL_FUNCTIONS IS
    ...
    BEGIN
        ...
        RETURN TO_LBAC_DATA_LABEL('HR_OLS_POLICY', 'C:GE:' || country_code);
    END;
    ...
    BEGIN
        ...
        RETURN TO_LBAC_DATA_LABEL('HR_OLS_POLICY', 'C:' || PRIVATE_LABEL_FUNCTIONS.get_emp_compartments(group_type) || ':' || country_code);
    END;
    ...
    BEGIN
        ...
        RETURN TO_LBAC_DATA_LABEL('HR_OLS_POLICY', 'C:HR:' || country_code);
    END;
END LABEL_FUNCTIONS;
/
